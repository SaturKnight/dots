...
static const char *fonts[]          = {"Cozette:pixelsize=20:antialias=false" ,"Symbols Nerd Font:size=12:antialias=true" };

// theme
#include "themes/galerion.h"
...
static const Key keys[] = {
    ...
    {MODKEY,                            XK_F11,  spawn, SHCMD("amixer set Master 1%-") },
    {MODKEY,                            XK_F10,         spawn, SHCMD("amixer set Master toggle") },
    {MODKEY,                            XK_F12,  spawn, SHCMD("amixer set Master 1%+") },
    {MODKEY,				XK_F6,	  spawn, SHCMD("xbacklight -inc 1") },
    {MODKEY,				XK_F5, spawn, SHCMD("xbacklight -dec 1") },
